...
class Client extends Component {
    ...
    render() {
        return ( <
            ...
            <
            h4 className = "title mb-4" > The Japanese Market < span className = "text-primary" > Opportunity < /span></h4 >
            <
            p className = "text-muted para-desc mx-auto mb-0" > < span className = "text-primary font-weight-bold" > Crowd Launch < /span> manages everything from launching your crowdfunding campaign, to social media marketing, traffic, and sales.</p >
            <
            /div> <
            /Col> <
            /Row>
            ...
            <
            h4 className = "title mb-4" > How we work. < /h4> <
            p className = "text-muted para-desc mx-auto mb-0" > Start working with < span className = "text-primary font-weight-bold" > Crowd Launch < /span> that can provide everything you need to generate awareness, drive traffic, connect.</p >

            <
            div className = "mt-4" >
            <
            Link to = "#"
            className = "btn btn-primary mt-2 mr-2" > Get Started Now < /Link> <
            Link to = "#"
            className = "btn btn-outline-primary mt-2" > Free Trial < /Link> <
            /div> <
            /div> <
            /Col> <
            /Row> <
